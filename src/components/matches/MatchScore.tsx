...
export function MatchScore({ match }: { match: MatchInfo }) {
  ...
  const leftColor = winner === match.team_left ? "#34d399" : winner === match.team_right ? "#f87171" : "#fbbf24";
  const rightColor = winner === match.team_right ? "#34d399" : winner === match.team_left ? "#f87171" : "#fbbf24";
